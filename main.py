...
def attack(char_name: str, char_class: str) -> str:
    """Персонаж выполняет атаку."""
    if char_class == 'warrior':
        attack_point: int = 5 + randint(3, 5)
        return (f'{char_name} нанёс урон противнику равный {attack_point}')
    if char_class == 'mage':
        attack_point = 5 + randint(5, 10)
        return (f'{char_name} нанёс урон противнику равный {attack_point}')
    if char_class == 'healer':
        attack_point = 5 + randint(-3, -1)
        return (f'{char_name} нанёс урон противнику равный {attack_point}')
    return (f'{char_name} нанёс урон противнику равный 1')


def defence(char_name: str, char_class: str) -> str:
    """Персонаж защищается."""
    if char_class == 'warrior':
        defence_point: int = 10 + randint(5, 10)
    ...
    if char_class == 'healer':
        ...
        return (f'{char_name} блокировал {defence_point} урона')
    return (f'{char_name} блокировал 1 урона')


def special(char_name: str, char_class: str) -> str:
    """Персонаж выполняет особое умение."""
    if char_class == 'warrior':
        special_point: int = 80 + 25
